    ...
    <nav id="sidebar">
        ...
        <div class="sidebar-content">
                    ...
                    <ul class="list-inline mt-10">
                        <li class="list-inline-item">
                            @if (session('adminName'))
                                <p class="align-middle link-effect text-primary-dark font-w600">
                                    {{ session('adminName') }}
                                </p>
                            @endif
                        </li>
            ...
            <div class="content-side content-side-full">
                <ul class="nav-main">
                    <li>
                        <a class="{{request()->is('admin/dashboard')?'active':''}}" href="{{route('dashboard')}}" wire:navigate><i class="si si-cup"></i><span
                                class="sidebar-mini-hide active">Dashboard</span></a>
                    </li>
                    <li>
                        <a class="{{request()->is('*/category/*')?'active':''}}" href="{{route('category.index')}}" wire:navigate><i class="si si-social-dropbox"></i><span
